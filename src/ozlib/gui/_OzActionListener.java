 ...
 * _OzActionListener
 *
 * @version  $Id: _OzActionListener.java,v 1.8 1997/07/18 01:56:44 nito Exp $
 * @see      _ActionListener_cl
 */


public final class _OzActionListener
             ...
             java.awt.event.ActionListener
{
  ...
  _OzActionListener(_EventDispatchingQueue_if queue)
    throws Exception
  {
    eventQueue = queue;
  }
  ...
  public final void actionPerformed(java.awt.event.ActionEvent actionEvent)
  {
    try {
      ...
      _OzActionEvent arg_e = new _OzActionEvent(actionEvent.getSource(), actionEvent.getID(), actionEvent.getActionCommand(), actionEvent.getModifiers());
      object = new _ActionEvent_cl(arg_e);
      _EventUnit_if event = null;
      event = (_EventUnit_cl)
	(new _EventUnit_cl()._new_create(listener, object, _ACTIONPERFORMED_));
