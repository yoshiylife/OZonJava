 ...
 * _OzItemListener
 *
 * @version  $Id: _OzItemListener.java,v 1.8 1997/07/18 01:56:44 nito Exp $
 * @see      _ItemListener_cl
 */


public final class _OzItemListener
             ...
             java.awt.event.ItemListener
{
  ...
  _OzItemListener(_EventDispatchingQueue_if queue)
    throws Exception
  {
    eventQueue = queue;
  }
  ...
  public final void itemStateChanged(java.awt.event.ItemEvent itemEvent)
  {
    try {
      ...
      _OzItemEvent  arg_e = new _OzItemEvent(itemEvent.getItemSelectable(), itemEvent.getID(), itemEvent.getItem(), itemEvent.getStateChange());
      object = new _ItemEvent_cl(arg_e);
      _EventUnit_if event = null;
      event = (_EventUnit_cl)
	(new _EventUnit_cl()._new_create(listener, object, _ITEMSTATECHANGED_));
