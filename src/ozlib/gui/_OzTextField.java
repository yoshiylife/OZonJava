 ...
 * _OzTextField
 *
 * @version  $Id: _OzTextField.java,v 1.5 1997/06/18 12:58:14 nito Exp $
 * @see      _TextField_cl
 */


public final class _OzTextField
  ...
  implements JP.go.ipa.oz.lib.standard._OzHoldable
{
  ...
  public _OzTextField(java.lang.String text)
    throws Exception
  {
    super(text);
  }

  public _OzTextField(int columns)
    throws Exception
  {
    super(columns);
  }

  public _OzTextField(java.lang.String text, int columns)
    throws Exception
  {
    super(text, columns);
  }
