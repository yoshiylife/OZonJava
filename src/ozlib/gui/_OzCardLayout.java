 ...
 * _OzCardLayout
 *
 * @version  $Id: _OzCardLayout.java,v 1.5 1997/06/18 12:58:12 nito Exp $
 * @see      _CardLayout_cl
 */


public final class _OzCardLayout
  ...
  implements JP.go.ipa.oz.lib.standard._OzHoldable
{
  ...
  public _OzCardLayout()
    throws Exception
  {
    super();
  }

  public _OzCardLayout(int hgap, int vgap)
    throws Exception
  {
    super(hgap, vgap);
  }
