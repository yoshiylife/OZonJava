 ...
 * _OzScrollbar
 *
 * @version  $Id: _OzScrollbar.java,v 1.5 1997/06/18 12:58:14 nito Exp $
 * @see      _Scrollbar_cl
 */


public final class _OzScrollbar
  ...
  implements JP.go.ipa.oz.lib.standard._OzHoldable
{
  ...
  public _OzScrollbar(int orientation)
    throws Exception
  {
    super(orientation);
  }

  public _OzScrollbar(int orientation, int value, int visible, int minimum, int maximum)
    throws Exception
  {
