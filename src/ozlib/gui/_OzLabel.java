 ...
 * _OzLabel
 *
 * @version  $Id: _OzLabel.java,v 1.5 1997/06/18 12:58:13 nito Exp $
 * @see      _Label_cl
 */


public final class _OzLabel
  ...
  implements JP.go.ipa.oz.lib.standard._OzHoldable
{
  ...
  public _OzLabel(String text)
    throws Exception
  {
    super(text);
  }

  public _OzLabel(String text, int alignment)
    throws Exception
  {
