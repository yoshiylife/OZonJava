...
/**
 * _OzContainerListener
 *
 * @version  $Id: _OzContainerListener.java,v 1.7 1997/07/18 01:56:44 nito Exp $
 * @see      _ContainerListener_cl
 */


public final class _OzContainerListener
             ...
             java.awt.event.ContainerListener
{
  ...
  _OzContainerListener(_EventDispatchingQueue_if queue)
    throws Exception
  {
    eventQueue = queue;
  }
  ...
  public void componentAdded(java.awt.event.ContainerEvent e)
  {
    try {
      ...
      _OzContainerEvent  arg_e = new _OzContainerEvent(e.getContainer(), e.getID(), e.getChild());
      object = new _ContainerEvent_cl(arg_e);
      _EventUnit_if event = null;
      event = (_EventUnit_cl)
        (new _EventUnit_cl())._new_create(listener, object, _COMPONENTADDED_);
...
//      throw new JP.go.ipa.oz.lang.OzException(ex_oz);
  ...
  public void componentRemoved(java.awt.event.ContainerEvent e)
  {
    try {
      ...
      _EventUnit_if event = null;
      event = (_EventUnit_cl)
        (new _EventUnit_cl())._new_create(listener, object, _COMPONENTREMOVED_);
      eventQueue.post (event);
    } catch (Exception ex) {
//      _RuntimeException_if ex_oz
//      = (_RuntimeException_cl)
