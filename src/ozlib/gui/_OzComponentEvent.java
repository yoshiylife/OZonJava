 ...
 * _OzComponentEvent
 *
 * @version  $Id: _OzComponentEvent.java,v 1.5 1997/06/18 12:58:12 nito Exp $
 * @see      _ComponentEvent_cl
 */


public final class _OzComponentEvent
  ...
  implements JP.go.ipa.oz.lib.standard._OzHoldable
{
  ...
  public _OzComponentEvent(java.awt.Component source, int id)
    throws Exception
  {
    super(source, id);
  }
