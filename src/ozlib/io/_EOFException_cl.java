...
/*
 * $Id: _EOFException_cl.java,v 1.3 1997/06/17 10:12:56 xsun Exp $
*/

package JP.go.ipa.oz.lib.standard;

public class _EOFException_cl
	extends _IOException_cl
	implements _EOFException_if
{
	static java.lang.String CN = "EOFException";
	
	public _EOFException_cl() throws Exception{
	}
