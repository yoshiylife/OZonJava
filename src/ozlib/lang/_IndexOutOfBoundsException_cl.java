...
public class _IndexOutOfBoundsException_cl
    extends _RuntimeException_cl
    implements _IndexOutOfBoundsException_if
{
    static java.lang.String CN = "IndexOutOfBoundsException";
        
    public _IndexOutOfBoundsException_cl() throws Exception
    {
    }
