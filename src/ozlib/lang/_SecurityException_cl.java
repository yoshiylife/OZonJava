...
public class _SecurityException_cl
    extends _RuntimeException_cl
    implements _SecurityException_if
{
    static java.lang.String CN = "SecurityException";
        
    public _SecurityException_cl() throws Exception
    {
    }
