...
public class _ArrayStoreException_cl
    extends _RuntimeException_cl
    implements _ArrayStoreException_if
{
    static java.lang.String CN = "ArrayStoreException";
        
    public _ArrayStoreException_cl() throws Exception
    {
    }
