...
public class _IllegalMonitorStateException_cl
    extends _RuntimeException_cl
    implements _IllegalMonitorStateException_if
{
    static java.lang.String CN = "IllegalMonitorStateException";
        
    public _IllegalMonitorStateException_cl() throws Exception
    {
    }
