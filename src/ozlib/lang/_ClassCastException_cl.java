...
public class _ClassCastException_cl
    extends _RuntimeException_cl
    implements _ClassCastException_if
{
    static java.lang.String CN = "ClassCastException";
        
    public _ClassCastException_cl() throws Exception
    {
    }
