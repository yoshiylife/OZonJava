...
public class _NegativeArraySizeException_cl
    extends _RuntimeException_cl
    implements _NegativeArraySizeException_if
{
    static java.lang.String CN = "NegativeArraySizeException";
        
    public _NegativeArraySizeException_cl() throws Exception
    {
    }
