...
public class _ArithmeticException_cl
    extends _RuntimeException_cl
    implements _ArithmeticException_if
{
    static java.lang.String CN = "ArithmeticException";
        
    public _ArithmeticException_cl() throws Exception
    {
    }
