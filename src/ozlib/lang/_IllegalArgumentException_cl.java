...
public class _IllegalArgumentException_cl
    extends _RuntimeException_cl
    implements _IllegalArgumentException_if
{
    static java.lang.String CN = "IllegalArgumentException";
        
    public _IllegalArgumentException_cl() throws Exception
    {
    }
