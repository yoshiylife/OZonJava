...
public class _ArrayIndexOutOfBoundsException_cl
    extends _RuntimeException_cl
    implements _ArrayIndexOutOfBoundsException_if
{
    static java.lang.String CN = "ArrayIndexOutOfBoundsException";
        
    public _ArrayIndexOutOfBoundsException_cl() throws Exception
    {
    }
