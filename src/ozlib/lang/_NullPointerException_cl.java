...
public class _NullPointerException_cl
    extends _RuntimeException_cl
    implements _NullPointerException_if
{
    static java.lang.String CN = "NullPointerException";
        
    public _NullPointerException_cl() throws Exception
    {
    }
