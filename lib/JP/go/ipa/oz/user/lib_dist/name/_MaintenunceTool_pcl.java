...
public class _MaintenunceTool_pcl extends JP.go.ipa.oz.lang._Proxy_cl implements JP.go.ipa.oz.user.lib_dist.name._MaintenunceTool_if {
  protected int part;
  ...
  protected Object invoke (JP.go.ipa.oz.system.OzCell o) throws Exception {
    ...
    JP.go.ipa.oz.user.lib_dist.name._MaintenunceTool_if g = (JP.go.ipa.oz.user.lib_dist.name._MaintenunceTool_if) o;
    Object result;
