...
public class removeGroup_cl extends JP.go.ipa.oz.system.OzCell implements JP.go.ipa.oz.user.secu.removeGroup_if {
...
// 9
    if (isequal$val$2) {
// 10
      JP.go.ipa.oz.lib.standard._String_if string$1 = (new JP.go.ipa.oz.lib.standard._String_cl("usage:removeGroup groupName"));
...
// 13
  ...
  public removeGroup_cl () { super ("JP.go.ipa.oz.user.secu.removeGroup_pcl"); }
  
  public removeGroup_cl (String proxy_id) { super (proxy_id); }
