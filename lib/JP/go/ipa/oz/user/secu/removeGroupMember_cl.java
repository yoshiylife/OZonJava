...
public class removeGroupMember_cl extends JP.go.ipa.oz.system.OzCell implements JP.go.ipa.oz.user.secu.removeGroupMember_if {
...
// 9
    if (isequal$val$2) {
// 10
      JP.go.ipa.oz.lib.standard._String_if string$1 = (new JP.go.ipa.oz.lib.standard._String_cl("usage:removeGroupMember userGroupName member"));
...
// 14
  ...
  public removeGroupMember_cl () { super ("JP.go.ipa.oz.user.secu.removeGroupMember_pcl"); }
  
  public removeGroupMember_cl (String proxy_id) { super (proxy_id); }
