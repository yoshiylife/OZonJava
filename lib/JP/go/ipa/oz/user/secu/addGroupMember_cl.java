...
public class addGroupMember_cl extends JP.go.ipa.oz.system.OzCell implements JP.go.ipa.oz.user.secu.addGroupMember_if {
...
// 9
    if (isequal$val$2) {
// 10
      JP.go.ipa.oz.lib.standard._String_if string$1 = (new JP.go.ipa.oz.lib.standard._String_cl("usage:addGroupMember userGroupName member"));
...
// 14
  ...
  public addGroupMember_cl () { super ("JP.go.ipa.oz.user.secu.addGroupMember_pcl"); }
  
  public addGroupMember_cl (String proxy_id) { super (proxy_id); }
