...
public class showGroup_cl extends JP.go.ipa.oz.system.OzCell implements JP.go.ipa.oz.user.secu.showGroup_if {
...
// 6
  ...
  public showGroup_cl () { super ("JP.go.ipa.oz.user.secu.showGroup_pcl"); }
  
  public showGroup_cl (String proxy_id) { super (proxy_id); }
